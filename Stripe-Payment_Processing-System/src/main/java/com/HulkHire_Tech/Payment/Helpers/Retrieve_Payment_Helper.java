...
public class Retrieve_Payment_Helper {
    @Value("${stripe.secret.key}")
    private String StripeSecretKey;
    @Value("${stripe.retrieve.session.url}")
    private String StripeRetrieveSessionTemplate;
    ...
    public HttpRequestData PrepareHttpRequest(String id) {
        ...
        String RetriveSessionUrl = StripeRetrieveSessionTemplate.replace("{id}", id);

        HttpRequestData requestData = new HttpRequestData();
        requestData.setHttpMethod(HttpMethod.GET);
        requestData.setUrl(RetriveSessionUrl);
    ...
    public Stripe_Response ProcessResponse(ResponseEntity<String> httpResponse) {
        ...
        throw new Error_Response(
                ErrorCode.RETRIVE_PAYMENT_FAILED.getErrorCode(), ErrorCode.RETRIVE_PAYMENT_FAILED.getErrorMessage(),
